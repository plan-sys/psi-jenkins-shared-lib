def call(taskFamily, cluster, service, dockerImageName, releaseNumber, memory, cpu){
  sh """
      ...
      aws ecs register-task-definition --family \$TASK_FAMILY --network-mode "awsvpc" --memory ${memory} --cpu ${cpu} --execution-role-arn "arn:aws:iam::341373978347:role/ecsTaskExecutionRole" --task-role-arn "arn:aws:iam::341373978347:role/ecsTaskExecutionRole" --requires-compatibilities "FARGATE" --cli-input-json "\$(echo \$FINAL_TASK)"
